            ...
            <div id='signin-wrapper'>
                <div id='signin-outer-box'>
                    ...
                    <div id='second-element'>
                        <Link to={'/signin'}>Sign in with a passkey</Link>
                        <h1>New to Github? <Link to={'/signup'}>Create an account</Link></h1>
                    </div>
                    ...
                    <div id='third-element'>
                        ...
                        <Link>Privacy</Link>
                        <Link>Docs</Link>
                        <Link>Contact Github Support</Link>
                    </div>
                </div>
            </div>
        </>
